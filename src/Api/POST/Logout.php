...
/**
 * Implements a controller for API handler "logout" page which render form for
 * authentication.
 *
...
class Logout implements \App\Controller
{
    ...
    /**
     * Creates new controller of API handler "logout" page and sets required
     * dependency.
     */
    ...
    /**
     * Runs controller of API handler "logout".
     *
